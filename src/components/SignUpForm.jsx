    ...
    <div className='bg-gray-900 text-white shadow hover:shadow-lg hover:shadow-gray-600 rounded-[10px] w-[80%] md:w-[80%] lg:w-[30%] p-[40px] my-10 m-auto'>
      ...
      <form className='flex flex-col '>
...

        {
          ...
          :
          <button onClick={(e)=>handleSubmit(e)} className='bg-blue-700 hover:bg-blue-600 rounded-4xl p-3 text-[16px]'>Sign Up</button>
        }
        ...
        <p className='py-3'>Already have an account ? 
          <Link to='/login' className='text-blue-400 hover:text-blue-500 underline'> Log in</Link></p>
      </form>
